...
from Adaptors.SpannerAdaptor import CDP_BBOS, CDP_Config, RuleTag, NAPL, SyncTag
...
class ETL_Spanner_BBOS_Service(CDP_BBOS):
    def __init__(self, spanner_db: str, bq_db):
        super(ETL_Spanner_BBOS_Service, self).__init__(database=spanner_db)
        self.bq_db = bq_db
    ...
    def login_log(self, hall: Hall, start, end):
        self.bq_db.statement = (
            ...
            FROM (
                ...
                JOIN `{self.bq_db.project_id}.ssr_dw_{hall.domain_name}.User_View` member 
    ...
    def vip_level(self, hall: Hall):
        ...
        self.bq_db.statement = (
            ...
            FROM `{self.bq_db.project_id}.ssr_dw_{hall.domain_name}.User_View` member 
            WHERE member.role = 1
            """
        )
        self.bq_db.mode = self.bq_db.QUERY_MODE
